...
export default function AudioPreviewSection({
  ...
  return (
    <div className="space-y-5 bg-zinc-950/60 p-4 rounded-2xl border border-zinc-800/80 shadow-xs">
        ...
        <div className="bg-zinc-900 p-3 rounded-xl border border-zinc-800 space-y-2">
          ...
          <div className="flex items-center gap-1.5">
            <input
              ...
              className="flex-1 min-w-0 bg-zinc-800 border border-zinc-700 rounded-lg px-2.5 py-1.5 text-sm font-mono text-white focus:outline-none focus:border-blue-500"
            />
            <button
              type="button"
